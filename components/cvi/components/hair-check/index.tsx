    ...
    <div className={styles.haircheckBlock}>
      ...
      <div className={styles.haircheckSidebar}>
        <div className={styles.haircheckSidebarContent}>
          {!isPermissionsGranted && (
            <div className="text-yellow-500 flex items-center justify-between gap-2">
              <Loader2 className="animate-spin" />

              <span>
                Waiting for permissions...
              </span>
              <button onClick={requestPermissions} className="text-white bg-green-500 px-2 py-1 rounded">
                Refresh
              </button>
            </div>
          )}
